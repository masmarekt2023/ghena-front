...
import {
  ...
  FormHelperText,
  IconButton,
  InputAdornment,  // Corrected import
  Dialog,
  DialogTitle,
  DialogContent,
  DialogContentText,
  DialogActions,   // Corrected import
} from "@mui/material"; // Unified MUI v5 imports
import { makeStyles } from "@mui/styles"; // Custom styles using makeStyles
import axios from "axios";
import Visibility from "@mui/icons-material/Visibility"; // Updated icon import
import VisibilityOff from "@mui/icons-material/VisibilityOff"; // Updated icon import
import CloseIcon from "@mui/icons-material/Close"; // Updated icon import
import { isValidEmail, isValidPassword } from "src/CommanFunction/Validation";
import Apiconfigs from "src/Apiconfig/Apiconfigs";
import { Link, useNavigate } from "react-router-dom";
import { UserContext } from "src/context/User";
